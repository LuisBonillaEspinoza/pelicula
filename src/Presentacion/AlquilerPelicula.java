 ...
 * @author LUIS
 */
public class AlquilerPelicula extends javax.swing.JFrame {

    /**
     * Creates new form AlquilerPelicula
     */
    ...
    void bloqueo() {
        ...
        fechade.setEditable(false);
    }

    void tabla() {
        String titulos[] = {"Codigo", "Nombre","Precio", "Genero"};
        ...
        try {
            ...
            while (rs.next()) {
                ...
                datos[2] = rs.getString("pelicula_double_precio");
                datos[3] = rs.getString("genero_txt_descrip");
    ...
    private void initComponents() {
        ...
        fechade = new javax.swing.JTextField();
        ...
        jLabel2.setText("Elija la pelicula a alquilar");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Datos del Alquiler", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Verdana", 0, 14))); // NOI18N
        ...
        jLabel7.setText("Precio de la Pelicula : ");

        txtnum.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N

        txtcod.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N

        fechapre.setDateFormatString("yyyy-MM-dd");
        fechapre.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N

        fechade.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        fechade.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                fechadeMouseClicked(evt);
            }
        });
        ...
        txtsipno.setRows(5);
        jScrollPane2.setViewportView(txtsipno);
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(fechade)
                            .addComponent(fechapre, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel5)
                    .addComponent(fechapre, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
    ...
    private void jtablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jtablaMouseClicked
        ...
        if (a < -1) {
            ...
            txtpre.setText(jtabla.getValueAt(a, 2).toString());
            Pelicula pe = new Pelicula();
            txtsipno.setText(pe.ObtenerSipnosis(a+1));
        }
    }//GEN-LAST:event_jtablaMouseClicked

    private void fechadeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_fechadeMouseClicked
        // TODO add your handling code here:
        String a;
        int dias = 3;
        a = ((JTextField) fechapre.getDateEditor().getUiComponent()).getText();
        System.out.println(a);
        String[] fech = a.split("-");
        Calendar calendar = Calendar.getInstance();
        calendar.set(Integer.parseInt(fech[0]), Integer.parseInt(fech[1]) - 1, Integer.parseInt(fech[2]));

        calendar.add(Calendar.DAY_OF_MONTH, dias);
        SimpleDateFormat fe = new SimpleDateFormat("yyyy-MM-dd");
        fechade.setText(fe.format(calendar.getTime()));
    }//GEN-LAST:event_fechadeMouseClicked
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            System.out.println("ERROR CCONTAR : " + e.getMessage());
        }
...
//fechapre.getCalendarButton().setEnabled(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlquilerPelicula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlquilerPelicula().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField fechade;
